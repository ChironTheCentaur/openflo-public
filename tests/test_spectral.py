...
def test_similarity_matrix_diagonal_is_one_even_for_zero_norm():
    """Self-similarity is 1 for every fluor, including a zero-norm (degenerate)
    spectrum — the diagonal must not read 0 (which hides the degenerate fluor)."""
