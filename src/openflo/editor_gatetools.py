        ...
        for target in target_names:
            ...
            if not append:
                ...
                if target == self._active_sample:
                    # Re-point the active-sample shortcuts at the freshly-cleared
                    # containers, else the copy below lands in the stale dict and
                    # self._gates desyncs from self._sample_gates[active].
                    self._gates = self._sample_gates[target]
                    self._gate_id_order = self._sample_gate_order[target]
